...
echo $values['userList']->beginElement($values['user']->getId(), ['class' => 'div-table-row item'])
    ...
    . '<div class="div-table-col">' . $values['userList']->textInput($values['user'], 'name', $rowParams + ['maxlength' => 30]) . '</div>'
    . '<div class="div-table-col">' . $values['userList']->textInput($values['user'], 'age', $rowParams + ['maxlength' => 30]) . '</div>'
